...
<body>
	...
	<p>
		...
		EL 구문내에 키 값만 제시하면 바로 접근 가능 <br>
		기본적으로 EL은 JSP 내장객체를 구분하지않고 자동으로 모든 
		내장 객체에 키 값을 검색하여 존재하면 값을 가져옴
	</p>
	...
	<h3>3. EL 사용시 내장 객체에 동일한 키 값으로 넣었을 경우</h3>
	<p>
		scope 값 : ${scope} <br>
		test 값 : ${ test }
	</p>
	<!-- 
		EL은 공유 범위가 제일 작은 scope부터 키 값을 검색함
		page => request => session => application
		application까지 찾았는데 키가 없으면 출력 안됨(오류X 빈칸출력)
	 -->
