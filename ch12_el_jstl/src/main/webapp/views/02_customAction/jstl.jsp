...
<body>
	<h1>JSTL이란?</h1>
	<p>
		JSP Standard Tag Library의 약자로 JSP에서 사용되는 커스텀 액션태그로
		공통적으로 자주 사용되는 태그들을 집합으로 만들어 보다 쉽게 사용할 수 있도록
	...
	<p>
		...
		&lt;%@ taglib prefix="접두어" uri="라이브러리 파일의 uri 주소" %&gt;
	</p>
	...
	<p>숫자, 날짜, 시간 등의 데이터 출력 형식을 지정할 때 사용하는 문법을 제공</p>
